...
private:
	...
	UFUNCTION()
		void OnOverlapBegin(UPrimitiveComponent * OverlappedCom, AActor* OtherActor, UPrimitiveComponent*OtherComp,int32 OtherBodyIndex,bool bFrowSweep,const FHitResult &SweepResult);
	UFUNCTION()
